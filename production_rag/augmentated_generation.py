...
try:
	from production_rag.rag_supabase import search_supabase
except ModuleNotFoundError:
	from rag_supabase import search_supabase
...
def generate_augmented_answer(
	...
	"""Run retrieval-augmented generation using Supabase."""

	docs = search_supabase(query, top_k=top_k)
...
if __name__ == "__main__":
	query = "What is the Embeddings and Softmax?"
